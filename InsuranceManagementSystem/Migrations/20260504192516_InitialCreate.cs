    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewsUpdates", x => x.NewsId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeInsurances", x => x.HomeInsuranceId);
                    table.ForeignKey(
                        name: "FK_HomeInsurances_Policies_PolicyId",
                        column: x => x.PolicyId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TermPeriod = table.Column<int>(type: "int", nullable: false),
                    ...
                    BeneficiaryRelation = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LifeInsurances", x => x.LifeInsuranceId);
                    table.ForeignKey(
                        name: "FK_LifeInsurances_Policies_PolicyId",
                        column: x => x.PolicyId,
                        principalTable: "Policies",
                        principalColumn: "PolicyId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PolicyValue = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreExistingConditionDetails = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalInsurances_Policies_PolicyId",
                        column: x => x.PolicyId,
                        principalTable: "Policies",
                        principalColumn: "PolicyId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MotorInsuranceId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PolicyId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MotorInsurances", x => x.MotorInsuranceId);
                    table.ForeignKey(
                        name: "FK_MotorInsurances_Policies_PolicyId",
                        column: x => x.PolicyId,
                        principalTable: "Policies",
                        principalColumn: "PolicyId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomeInsurances_PolicyId",
                table: "HomeInsurances",
                column: "PolicyId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LifeInsurances_PolicyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalInsurances_PolicyId",
                table: "MedicalInsurances",
                column: "PolicyId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MotorInsurances_PolicyId",
                table: "MotorInsurances",
                column: "PolicyId",
                unique: true);
